...
os.environ['KAGGLE_CONFIG_DIR'] = "Your path"  # Update this path to your Kaggle configuration directory
# Specify the dataset identifier
dataset = 'piterfm/paris-2024-olympic-summer-games'
# Set the download path
download_path = 'Your download path' # Change this to your preferred download directory
